...
syn match nagiosDef 'define[ \t]\+\(host\|service\|contact\)group'
...
syn region nagiosDefBody start='{' end='}' contains=nagiosDirective,nagiosMacro,nagiosConstant,nagiosString,nagiosSpecial,nagiosComment transparent
...
syn keyword nagiosDirective  contact_groups contact_name contactgroup_name contacts
...
syn keyword nagiosDirective  saturday service_description servicegroup_name
